...
class RBallGame:
    '''A RBallGame represents a game in progress. A game has two
    ...
    def __init__(self, probA, probB):
        ...
        self.server = self.playerA  # Player A always servers first
    ...
    def getScores(self):
        '''Returns the current score of player A and player B'''
